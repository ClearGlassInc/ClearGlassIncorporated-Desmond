...
- **Audit coverage:** 155 public pages are connected and 12 utility, completion, prototype, or private pages are explicitly excluded.
...
| `minerals.html` — Critical Minerals Intelligence | transparent mineral supply-chain data and provenance | Guardian Command Nexus Spec | Intelligence | Intelligence | Book a security engagement / See pricing & plans |
...
| `mission-control.html` — Mission Control | engineering mission outcomes and operational status | Command Center | PERCIVAL OS | PERCIVAL OS | Browse services & engagements / See pricing & plans |
...
| `blog/ai-safety-black-box-activation-analysis-gavel.html` — AI Safety Beyond the Black Box | activation analysis and layered AI guardrails | Shadow AI Incident Response | ClearGlass Intelligence | ClearGlass Intelligence | Book a security engagement / See pricing & plans |
