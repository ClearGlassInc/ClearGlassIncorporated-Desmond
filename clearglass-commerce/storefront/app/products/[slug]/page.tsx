...
// Next 15/16: route params are async. In a Client Component they're unwrapped
// with React's use() hook (Server Components would await them instead).
export default function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article>
      ...
      <h1 style={{ fontSize: 30, marginTop: 12 }}>{product ? product.title : slug}</h1>
