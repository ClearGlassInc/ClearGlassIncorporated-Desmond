...
### Value-first (LinkedIn DM) — Linkedin
...
### Pilot-focused (Short + direct) — Linkedin
...
## 2) CPA Partner One-Pager

### ClearGlass CPA Partner Program
_Turn your client base into recurring revenue with real-time financial intelligence_

**What ClearGlass Does**
...
| Tier | Description | Revenue Potential |
|---|---|---|
| Starter | 3–10 clients | $300–$3K MRR |
| Growth | 10–50 clients | $3K–$15K MRR |
| White-label | Full deployment | $999+/mo per bundle |
...
## 3) Weekly Micro Execution Plan

**Day 1–2 — Update landing page**

- "Flinks-powered real-time data" headline
- Demo screenshot (even staging/mock)
- CTA: Start a 14-day partner trial

**Day 3–5 — Send 50 outreach messages**
...
- **Early Baseline:** 3 CPAs × 5 clients × $99 = ~$1,500 MRR
- **White Label Add:** +$999 MRR per white-label deal
- **Ramp 60 90 Days:** Realistic trajectory toward $8K–$25K MRR
...
| Metric | Target |
|---|---|
| Outreach Volume Per Week | 50 touches (30 LinkedIn + 20 email) |
| Target Demos Booked | 5–10 per week |
| Target Pilot Partners | 2–3 per week |
| Trial Length Days | 14 |
| Per Client Pricing | $99–$299/mo |
| White Label Pricing | $999+/mo per client cluster |
| Icp Qualifier | Canadian CPAs / fractional CFOs / bookkeeping firms with 5–50 SMB clients |
