...
(function () {
  ...
  var css = "\
#cg-global-nav.cg-topnav{position:fixed;top:16px;left:50%;transform:translateX(-50%);width:min(1300px,calc(100% - 2rem));z-index:2147483000;height:80px;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:0 16px 0 14px;border-radius:48px!important;background:linear-gradient(180deg,#2b2552 0%,#161232 46%,#0b0a1c 100%)!important;-webkit-backdrop-filter:blur(16px) saturate(1.4)!important;backdrop-filter:blur(16px) saturate(1.4)!important;border:1px solid rgba(200,185,255,.4)!important;box-shadow:0 0 0 1.5px rgba(150,110,240,.35),0 18px 54px rgba(60,25,140,.45),0 0 96px rgba(150,100,245,.42),0 0 32px rgba(150,100,245,.3),inset 0 2px 1px rgba(255,255,255,.34),inset 0 0 22px rgba(150,110,240,.14),inset 0 -16px 38px rgba(0,0,0,.62)!important;font-family:'Urbanist',Inter,system-ui,sans-serif;overflow:visible;color:#eef0ff!important}\
