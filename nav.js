...
(function () {
  ...
  var css = [
    ".cg-native-nav-hidden,.cg-native-header-hidden{display:none!important}.cg-global-nav-enabled{--cg-unified-nav-offset:clamp(76px,6.5vw,100px)}",
    ".cg-topnav{position:fixed;top:clamp(10px,1.4vw,18px);left:50%;transform:translateX(-50%);width:min(1560px,calc(100% - clamp(1.5rem,3vw,4rem)));z-index:2147483000;min-height:62px;display:flex;align-items:center;justify-content:space-between;gap:clamp(1rem,2vw,2.25rem);padding:.5rem clamp(.85rem,1.3vw,1.4rem);border-radius:999px;border:1px solid rgba(255,255,255,.1);background:linear-gradient(90deg,rgba(14,20,40,.82),rgba(11,16,34,.86));backdrop-filter:blur(22px) saturate(1.3);-webkit-backdrop-filter:blur(22px) saturate(1.3);box-shadow:0 10px 34px rgba(6,10,24,.32),inset 0 1px 0 rgba(255,255,255,.08);font-family:Urbanist,Inter,system-ui,sans-serif;isolation:isolate;overflow:visible}",
    ".cg-topnav:before{content:\"\";position:absolute;inset:0;border-radius:inherit;z-index:-1;pointer-events:none;background:linear-gradient(180deg,rgba(255,255,255,.06),transparent 42%)}",
    ".cg-topnav:after{display:none}",
    ".cg-topnav *{box-sizing:border-box}.cg-brand{position:relative;display:flex;align-items:center;gap:clamp(10px,1vw,14px);min-width:max-content;color:#f4f7ff;text-decoration:none}.cg-brand:after{display:none}",
    ".cg-mark{position:relative;width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 34% 24%,rgba(255,255,255,.92),rgba(210,218,236,.8) 42%,rgba(28,35,56,.92) 82%);border:1px solid rgba(255,255,255,.35);box-shadow:0 2px 10px rgba(0,0,0,.35),inset 0 1px 2px rgba(255,255,255,.4);overflow:hidden;flex:0 0 auto}.cg-mark img{position:relative;width:98%;height:98%;object-fit:contain;border-radius:50%}",
    ".cg-name{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(1.15rem,1.7vw,1.6rem);font-weight:600;letter-spacing:-.02em;line-height:1;white-space:nowrap}.cg-name em{font-family:'Cormorant Garamond',Georgia,serif;font-style:italic;font-weight:400;color:#b9a7f0;letter-spacing:.01em;margin-left:.3rem}",
    ".cg-links{display:flex;align-items:center;gap:clamp(.15rem,.5vw,.55rem);margin-left:auto}.cg-links a,.cg-dropbtn{position:relative;color:rgba(230,236,250,.86);text-decoration:none;font-size:clamp(.86rem,.95vw,.98rem);font-weight:600;padding:8px 12px;border-radius:10px;border:0;background:transparent;cursor:pointer}.cg-links a:after,.cg-dropbtn:after{content:\"\";position:absolute;left:12px;right:12px;bottom:3px;height:2px;border-radius:999px;background:linear-gradient(90deg,#7fa8ff,#c07dff);opacity:0;transform:scaleX(.6);transition:.18s}.cg-links a:hover,.cg-dropbtn:hover{color:#fff;background:rgba(255,255,255,.06)}.cg-links a:hover:after,.cg-dropbtn:hover:after{opacity:.9;transform:scaleX(1)}",
    ".cg-cta{display:inline-flex!important;align-items:center;gap:8px;background:linear-gradient(180deg,rgba(139,92,246,.95),rgba(91,54,170,.96))!important;color:#fff!important;margin-left:clamp(.3rem,.7vw,.75rem);padding:9px 18px!important;border:1px solid rgba(205,146,255,.5)!important;border-radius:999px!important;font-size:clamp(.86rem,.95vw,.98rem);font-weight:650;box-shadow:0 4px 16px rgba(120,70,220,.35)}.cg-cta svg{width:18px;height:18px;flex:0 0 auto;color:#f0e2ff}.cg-cta:hover{background:linear-gradient(180deg,rgba(150,104,255,.98),rgba(101,62,185,.98))!important}.cg-cta:after{display:none}",
    ".cg-drop{position:relative}.cg-menu{position:absolute;top:calc(100% + 12px);left:50%;transform:translateX(-50%) translateY(-6px);width:min(980px,92vw);max-height:min(72vh,720px);overflow:auto;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:7px;padding:10px;background:rgba(16,24,50,.97);border:1px solid rgba(185,156,255,.3);border-radius:20px;box-shadow:0 22px 60px rgba(8,13,35,.4);opacity:0;pointer-events:none;transition:.18s;backdrop-filter:blur(24px)}.cg-drop:hover .cg-menu,.cg-drop:focus-within .cg-menu{opacity:1;pointer-events:auto;transform:translateX(-50%) translateY(0)}.cg-prod{display:flex!important;gap:10px!important;align-items:center!important;padding:10px!important;border-radius:12px!important;color:#eef4ff!important;background:transparent!important}.cg-prod:hover{background:rgba(255,255,255,.08)!important}.cg-ic{width:30px;height:30px;border-radius:10px;background:rgba(255,255,255,.08);display:grid;place-items:center;flex:0 0 auto}.cg-prod b{display:block;font-size:13px;line-height:1.15}.cg-prod small{display:block;margin-top:3px;font-family:'IBM Plex Mono',monospace;font-size:9px;letter-spacing:.06em;text-transform:uppercase;color:#aeb9d5}",
    ".cg-toggle{display:none;border:1px solid rgba(196,139,255,.45);background:rgba(7,10,24,.7);color:#fff;border-radius:12px;padding:8px 10px}.cg-mobile{position:fixed;top:84px;left:.75rem;right:.75rem;z-index:2147482999;display:none;grid-template-columns:1fr;gap:4px;max-height:calc(100vh - 100px);overflow:auto;padding:10px;background:rgba(16,24,50,.98);border:1px solid rgba(185,156,255,.3);border-radius:20px;box-shadow:0 12px 48px rgba(10,12,16,.28)}.cg-mobile.open{display:grid}.cg-mobile a{padding:12px 14px;border-radius:12px;text-decoration:none;color:#eef4ff;font-weight:650}.cg-mobile a:hover{background:rgba(255,255,255,.08)}.cg-label{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.15em;text-transform:uppercase;color:#aeb9d5;padding:10px 14px 4px}",
    ".cg-topnav+main,.cg-topnav~main{scroll-margin-top:94px}.cg-topnav~:is(main,.page,.wrap){padding-top:max(92px,env(safe-area-inset-top))}.cg-unified-page :is(section,.section,.panel,.card){border-radius:clamp(16px,2vw,24px)}body{--cg-home-rhythm:clamp(80px,12vw,140px)}main :is(h1,h2){letter-spacing:-.025em}main :is(.eyebrow,.kicker,.label,.mono){letter-spacing:.12em;text-transform:uppercase}.btn,.button,a[class*=cta],button[class*=cta]{border-radius:999px}@media(max-width:1240px){.cg-links{display:none}.cg-toggle{display:block}.cg-topnav{min-height:54px}.cg-menu{grid-template-columns:1fr}}@media(max-width:760px){.cg-topnav{top:8px;width:calc(100% - 1rem);min-height:50px;padding:.4rem .7rem}.cg-name{font-size:16px}.cg-name em{display:none}.cg-mark{width:34px;height:34px}.cg-mobile{top:72px;max-height:calc(100vh - 88px)}}"
  ].join("");
